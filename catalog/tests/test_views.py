...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_form_invalid_renewal_date_past(self):
        ...
        self.assertFormError(form, 'renewal_date', 'Invalid date - renewal in past')
    ...
    def test_form_invalid_renewal_date_future(self):
        ...
        self.assertEqual( resp.status_code,200)
        self.assertEqual(resp.status_code, 200)
        self.assertContains(resp, 'Invalid date - renewal more than 4 weeks ahead')
...
class AuthorCreateViewTest(TestCase):
    ...
    def test_redirect_if_not_logged_in(self):
        ...
        self.assertRedirects(resp, '/accounts/login/?next=' + reverse('author_create'))
    ...
    def test_redirects_to_author_detail_on_success(self):
        ...
        resp = self.client.post(reverse('author_create'), post_data)
